...
let bigRationalTests =
    testList "BigRational" [
        ...
        testCase "FromInt creates integer BigRational" <| fun () ->
            let br = BigRational.FromInt 5
            Expect.equal (BigRational.ToInt32 br) 5 "FromInt should create integer BigRational"
        
        testCase "FromBigInt creates BigRational from BigInteger" <| fun () ->
        ...
        testCase "Parse negative rational" <| fun () ->
            let br = BigRational.Parse "-5/2"
            let expected = -2.5
            Expect.floatClose Accuracy.high (BigRational.ToDouble br) expected "Parse should handle negative rationals"
        
        // Addition tests
        testCase "Add two integers" <| fun () ->
            let br1 = BigRational.FromInt 3
            let br2 = BigRational.FromInt 4
            let result = br1 + br2
            Expect.equal (BigRational.ToInt32 result) 7 "3 + 4 should equal 7"
        
        testCase "Add integer and rational" <| fun () ->
        ...
        testCase "Add two rationals" <| fun () ->
        ...
        testCase "Multiply integer by rational" <| fun () ->
            let br1 = BigRational.FromInt 3
            let br2 = BigRational.Parse "1/2"
            let result = br1 * br2
        ...
        testCase "Numerator and denominator of integer" <| fun () ->
            let br = BigRational.FromInt 5
